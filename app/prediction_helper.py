...
model_young = joblib.load("app/artifacts/linear_regression_young_gr_model.joblib")
model_rest = joblib.load("app/artifacts/xgboost_rest_model.joblib")
scaler_young = joblib.load("app/artifacts/scaler_young_gr.joblib")
...
def predict(input_dict):
    ...
    if input_dict['Age'] <= 25:
        ...
        # DROP genetical_risk for rest model
        input_df = input_df.drop(columns=['genetical_risk'], errors='ignore')
